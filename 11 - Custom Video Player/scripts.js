...
function skip () {
  // doesn't protect against current time being too small or too big
  video.currentTime = +this.dataset.skip + video.currentTime;
}
...
function toggleFullscreen () {
  if (!isFullscreen) {
    ...
    if (video.cancelFullscreen) {
        ...
        container.mozCancelFullScreen(); // Firefox
    } else if (video.webkitCancelFullscreen) {
        video.webkitCancelFullscreen(); // Safari
